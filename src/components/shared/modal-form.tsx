  ...
  return (
    <ResponsiveModal open={isModalOpen} onOpenChange={handleCloseModal}>
      <ResponsiveModalContent
        ...
        className={cn(
          'dark:bg-clrOnyx scrollbar-hide h-full max-h-[calc(100dvh-2%)] bg-white lg:max-h-[calc(100vh-5%)] xl:min-w-[500px]',
        ...
        <div className="h-full">
          <div className="">
            <div className="flex items-center justify-between">
              <h3 className="font-montserrat py-2 text-[24px] font-extrabold">
            ...
            <hr className="text-clrAlienGreen" />
            <p className="my-3 mb-4 text-[12px] leading-[18px] tracking-wide lg:text-base lg:leading-[24px] dark:font-light">
              ...
              <ul className="flex justify-evenly gap-4 py-2 pt-4 xl:gap-6">
                {agentsData.map(({ id, img, name }, index) => (
                  ...
                  >
                    ...
                    <span className="block pt-1 text-center text-sm font-medium">
                      {name}
                    </span>
                  </li>
                ))}
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          ...
                          className="font-raleway border-clrTextLight h-11 text-sm"
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <PhoneInput
                        disabled={isSubmitting}
                        className="border-clrTextLight font-raleway h-11 text-sm"
                  ...
                  render={({ field }) => (
                    <FormItem className="">
                      ...
                      >
                        ...
                        <SelectContent className="dark:bg-clrOnyx text-clrTextLight bg-white dark:text-white">
                          {[
                            ...
                            <SelectItem
                              key={item.value}
                              value={item.value}
                              className="hover:bg-clrTextLight/10 font-raleway px-4 py-3 text-base"
                            >
                              {item.label}
                            </SelectItem>
                          ))}
