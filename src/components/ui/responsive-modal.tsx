    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          'dark:bg-clrOnyx h-full max-h-[calc(100vh-30px)] overflow-hidden bg-white xl:min-w-[500px]',
          className,
        )}
        {...props}
      >
        <div className="dark:bg-clrOnyx absolute inset-x-0 top-0 z-[999] h-[40px] bg-white"></div>
        <div className="scrollbar-hide max-h-[calc(100vh-60px)] overflow-y-auto scroll-smooth px-3 py-10 pt-5">
          {children}
        </div>
        <div className="dark:bg-clrOnyx absolute inset-x-0 bottom-0 z-[999] h-[40px] bg-white"></div>
