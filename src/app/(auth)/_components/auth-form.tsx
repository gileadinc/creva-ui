  ...
  return (
    <div className={cn('w-full pt-8', className)}>
      <div className="relative">
        ...
        <h1 className="font-raleway justify-start text-3xl leading-9 font-bold capitalize">
          {isSignUp ? 'Sign Up' : `Sign In`}
        </h1>
        <div className="mt-1 flex items-center gap-2">
          <span className="font-opensans block text-base leading-normal font-light">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <PhoneInput
                          className="border-clrTextLight font-raleway h-10 text-sm"
