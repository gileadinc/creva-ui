...
export default function SignUpPage() {
  return (
    <div
      className={cn(
        'dark:to-clrFirefly dark:from-clrBlackPearl size-full min-h-[100vh] bg-linear-52 px-[40px]',
      )}
    >
      <div className="grid h-full grid-cols-1 gap-4 lg:grid-cols-[1fr_1fr]">
        <div className="z-10 mx-auto grid size-full min-h-[100vh] w-full max-w-[500px] place-items-center py-[2%] md:min-w-[400px]">
